...
// Ambil data dari tabel regdokumen
$query = "SELECT * FROM regdokumen";
...
if (isset($_GET['id'])) {
    ...
    $query = "DELETE FROM regdokumen WHERE id = $id";

    if ($conn->query($query) === TRUE) {
        echo "Data berhasil dihapus!";
        header("Location: dsbr-regdokumen.php"); // Redirect kembali ke halaman tabel
    } else {
...
<body>
    ...
    <h2 style="padding:50px;margin-top:-20px;"><img src="img/logospan.png" style="width:50%;border-radius:10px;margin-left:-10px;"><img src="img/logo-blitar.png" style="width:50%;margin-left:10px;"></h2>
        <a href="dsbr-regdokumen.php"style="background-color:gray;">Registrasi Dan Dokumen</a>
            ...
            <table>
                <thead>
                    ...
                    <th style="text-align:center;">No</th>
                        ...
                        <th>Nama Pimpinan</th>
                        <th>Jabatan</th>
                        <th>Nama Individu Konsultan</th>
                        <th>No.Surat Permohonan</th>
                        <th>Nama Proyek</th>
                        <th>Ukuran/Kapasitas</th>
                        <th>Pembangunan/Pengembangan</th>
                        <th>Alamat Proyek</th>
                        <th>Tanggal Surat Permohonan</th>
                        <th>Bangkitan</th>
                        <th>File Bangkitan</th>
                        <th>Diupload</th>
                        <th>Download File</th>
                        <th>Hapus</th>
                    </tr>
                ...
                <?php if ($result->num_rows > 0): ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['nama_perseroan']; ?></td>
                        <td><?php echo $row['telepon']; ?></td>
                        <td><?php echo $row['nama_pimpinan']; ?></td>
                        <td><?php echo $row['jabatan']; ?></td>
                        <td><?php echo $row['nama_konsultan']; ?></td>
                        <td><?php echo $row['no_surat_pemohon']; ?></td>
                        <td><?php echo $row['nama_proyek']; ?></td>
                        <td><?php echo $row['kapasitas']; ?></td>
                        <td><?php echo $row['pembangunan']; ?></td>
                        <td><?php echo $row['alamat_proyek']; ?></td>
                        <td><?php echo $row['tanggal']; ?></td>
                        <td><?php echo $row['bangkitan']; ?></td>
                        <td><?php echo $row['file_bangkitan']; ?></td>
                        <td><?php echo date('d-m-Y H:i:s', strtotime($row['created_at']));?></td>
                        <td><a href="uploads/<?php echo $row['file_bangkitan']; ?>" download>Download</a></td>
                        <td><a style="color:red;" href="dsbr-regdokumen.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Hapus</a></td>
                    </tr>
                    <?php endwhile; ?>
                <?php else: ?>
                    <tr>
