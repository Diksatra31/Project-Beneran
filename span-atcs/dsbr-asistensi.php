...
if (isset($_GET['id'])) {
    ...
    $query = "DELETE FROM asistensi WHERE id = $id";

    if ($conn->query($query) === TRUE) {
        echo "Data berhasil dihapus!";
        header("Location: dsbr-asistensi.php"); // Redirect kembali ke halaman tabel
    } else {
...
<body>
    ...
    <h2 style="padding:50px;margin-top:-20px;"><img src="img/logospan.png" style="width:50%;border-radius:10px;margin-left:-10px;"><img src="img/logo-blitar.png" style="width:50%;margin-left:10px;"></h2>
        ...
        <a href="dsbr-asistensi.php"style="background-color:gray;">Asistensi</a>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>Konsultan</th>
                        <th>Catatan Yang Diberikan Oleh Tim Penilai</th>
                        <th>Bangkitan</th>
                ...
                <?php if ($result->num_rows > 0): ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['judul_permohonan']; ?></td>
                        <td><?php echo $row['konsultan']; ?></td>
                        <td><?php echo $row['catatan_penilai']; ?></td>
                        <td><?php echo $row['bangkitan']; ?></td>
                        <td><?php if (!empty($row['file_bangkitan'])): ?><span><?php echo $row['file_bangkitan']; ?></span><?php else: ?><span>Tidak ada file</span><?php endif; ?></td>
